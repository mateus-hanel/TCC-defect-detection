...
run_DEMO_EXPERIMENTS()
{
  ...
  train_single $SAVE_IMAGES STEEL $STEEL_PATH ALL_300_N_50_SYNTHETIC_V2_1    $RESULTS_PATH 1 300  .\\splits\\STEEL\\split_300_50_synthetic_2.pyb   90 0.1 0.1 10 True  2 1 True  True  True  ${GPUS[0]} # Figure 12
