...
run_DEMO_EXPERIMENTS()
{
  ...
  GPUS=($@)
    ...
    #train_KSDD "./datasets/KSDD_FLIP_DEFECT/" $SAVE_IMAGES N_0_FLIP_DEFECT    $RESULTS_PATH 7 33 0  50 1 0.01 1 False  2 1 False False False  "${GPUS[@]}" # Figure 7, Table 4-Row 13
    ...
    train_KSDD "./datasets/KSDD_FLIP_DEFECT/" $SAVE_IMAGES N_5_FLIP_DEFECT    $RESULTS_PATH 7 33 5  50 1 0.01 1 False  2 1 False False  False  "${GPUS[@]}" # Figure 7, Table 4-Row 12
	...
	train_KSDD "./datasets/KSDD_FLIP_DEFECT/" $SAVE_IMAGES N_10_FLIP_DEFECT   $RESULTS_PATH 7 33 10 50 1 0.01 1 False  2 1 False False  False  "${GPUS[@]}" # Figure 7
	#train_KSDD "./datasets/KSDD/" $SAVE_IMAGES N_10   $RESULTS_PATH 7 33 10 50 1 0.01 1 False  2 1 False False  False  "${GPUS[@]}" # Figure 7
    
	train_KSDD "./datasets/KSDD_FLIP_DEFECT/" $SAVE_IMAGES N_15_FLIP_DEFECT   $RESULTS_PATH 7 33 15 50 1 0.01 1 False  2 1 False False  False  "${GPUS[@]}" # Figure 7
	train_KSDD "./datasets/KSDD/" $SAVE_IMAGES N_15   $RESULTS_PATH 7 33 15 50 1 0.01 1 False  2 1 False False  False  "${GPUS[@]}" # Figure 7

    train_KSDD "./datasets/KSDD_FLIP_DEFECT/" $SAVE_IMAGES N_20_FLIP_DEFECT   $RESULTS_PATH 7 33 20 50 1 0.01 1 False  2 1 False False  False  "${GPUS[@]}" # Figure 7
    train_KSDD "./datasets/KSDD/" $SAVE_IMAGES N_20   $RESULTS_PATH 7 33 20 50 1 0.01 1 False  2 1 False False  False  "${GPUS[@]}" # Figure 7

    train_KSDD "./datasets/KSDD_FLIP_DEFECT/" $SAVE_IMAGES N_ALL_FLIP_DEFECT  $RESULTS_PATH 7 33 33 50 1 0.01 1 False  2 1 False False  False  "${GPUS[@]}" # Figure 7
