...
run_DEMO_EXPERIMENTS()
{
  ...
  #train_single $SAVE_IMAGES STEEL $STEEL_PATH ALL_300_N_50_SYNTHETHIC    $RESULTS_PATH 1 300  .\\splits\\STEEL\\split_300_50_synthetic.pyb   90 0.1 0.1 10 True  2 1 True  True  True  ${GPUS[0]} # Figure 12
  ...
  train_single $SAVE_IMAGES STEEL $STEEL_PATH ALL_300_N_300_SYNTHETHIC_2   $RESULTS_PATH 1 300  .\\splits\\STEEL\\split_300_300_synthetic.pyb  90 0.1 0.1 10 True  2 1 True  True  True  ${GPUS[0]} # Figure 12
  train_single $SAVE_IMAGES STEEL $STEEL_PATH ALL_300_N_50_SYNTHETHIC_3    $RESULTS_PATH 1 300  .\\splits\\STEEL\\split_300_50_synthetic.pyb   90 0.1 0.1 10 True  2 1 True  True  True  ${GPUS[0]} # Figure 12
  train_single $SAVE_IMAGES STEEL $STEEL_PATH ALL_300_N_300_SYNTHETHIC_4   $RESULTS_PATH 1 300  .\\splits\\STEEL\\split_300_300_synthetic.pyb  90 0.1 0.1 10 True  2 1 True  True  True  ${GPUS[0]} # Figure 12
